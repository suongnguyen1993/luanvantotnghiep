  ...
  <form id="frm-admin" method="post" action="">
                    <div class="form-group">
                      ...
                      Full name:
                        ...
                        <input type="text" class="form-control" required="required" name="fullname" id="fullname" placeholder="Full name" value="<?php echo $admin['fullname']; ?>">                      
                    </div> 
                    <div class="form-group">
                      <label for="username" class=" control-label">
                      User name:
                      </label>                      
                        <input type="text" class="form-control" required="required" name="username" id="username" placeholder="User name" value="<?php echo $admin['username']; ?>">                      
                    </div>
                    <div class="form-group">
                      <label for="email" class=" control-label">
                      Email:
                      </label>                      
                        <input type="email" class="form-control" required="required" name="email" id="email" placeholder="Email" value="<?php echo $admin['email']; ?>">                      
                    </div>
                    <div class="form-group">
