<base href="<?php echo base_url();?>">
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/font-awesome-4.3.0/css/font-awesome.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/admin/dist/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/admin/plugins/daterangepicker/daterangepicker-bs3.css">
