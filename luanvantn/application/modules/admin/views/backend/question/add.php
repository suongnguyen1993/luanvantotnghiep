...
<form id="frm-admin" method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">	
		...
		<textarea class="form-control" rows="5" placeholder=" Enter ..."
		 name="content" required="required" value = ""><?php echo $this->input->post('content') ?></textarea>
	</div>
	...
	<h4>Choose:</h4>
	    <div class="input-group">
		    ...
		    <input name="choosecontent1" required="required" type="text" value = "<?php echo $this->input->post('choosecontent1') ?>" placeholder = "Enter content of choose A " class="form-control" >
	    </div>
	</div>    
	<div class="form-group text-right">
	    <div class="input-group">
		    ...
		    <input name="choosecontent2" required="required" value = "<?php echo $this->input->post('choosecontent2') ?>" type="text" placeholder = "Enter content of choose B " class="form-control">
	    </div>
	</div>
	<div class="form-group text-right">
	    <div class="input-group">
		    ...
		    <input name="choosecontent3" required="required" value = "<?php echo $this->input->post('choosecontent3') ?>" type="text" placeholder = "Enter content of choose C " class="form-control">
	    </div>
	</div>
	<div class="form-group text-right" id="chooseD">
	    <div class="input-group">
		    ...
		    <input id="textD" name="choosecontent4" required="required" value = "<?php echo $this->input->post('choosecontent4') ?>" placeholder = "Enter content of choose D " type="text" class="form-control">
	    </div>
	</div> 
