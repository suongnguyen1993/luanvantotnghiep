  ...
  <form id="frm-admin" method="post" action="">
                    <div class="form-group">
                      ...
                      Info:
                        ...
                        <input type="text" class="form-control" name="info" id="info" placeholder="Info" value="<?php echo $exam['info'] ?>">                      
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      URL:
                        ...
                        <input type="text" class="form-control" name="url" id="url" placeholder="URL" value="<?php echo $exam['url'] ?>">                      
                    </div>
